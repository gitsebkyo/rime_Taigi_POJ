...
*目前第九調大多詞典都不收錄，所以根據使用狀況再看要不要寫入。

### 3. 三大核心按鍵
* **【空格 Space】**：**選字推送**。例如 `tai5oan5` → 出現候選表「1.tâi-oân /2. 台灣」，透過方向鍵+空格推送。
...
## 未來展望 Roadmap
*還有一些小bug，但rime切分字功能有限，請使用者全拼確保輸入正確。
*尊重字典，有些詞匯可能是百年前的讀音或用法，不予以修正，有限加入當代用法。(眼睛吃不消)
